...
public class LayoutHelp extends MainNavigation {
    ...
    ImageButton upSetUpButton, downSetUpButton, upDailyMoneyButton, downDailyMoneyButton, downMoneyInButton, upMoneyInButton, downMoneyOutButton, upMoneyOutButton,
            downCreditCardButton, upCreditCardButton, downPayCCButton, upPayCCButton, downWeeklyLimitsButton, upWeeklyLimitsButton, upBudgetButton, downBudgetButton,
            upDebtsButton, downDebtsButton, upSavingsButton, downSavingsButton, upSpendingReportButton, downSpendingReportButton, upContactUsButton, downContactUsButton;
    Intent email, web, goToRatings;
    LinearLayout setUpText, dailyMoneyText, moneyInText, moneyOutText, creditCardText, payCCText, weeklyLimitsText, budgetText, debtsText, savingsText, spendingReportText,
            contactUsText, ratingsLayout;
    ...
    View.OnClickListener onClickRatings = new View.OnClickListener() {
        @Override
        public void onClick(View v) {
            goToRatings = new Intent(Intent.ACTION_VIEW, Uri.parse("market://details?id=ca.gotchasomething.mynance"));
