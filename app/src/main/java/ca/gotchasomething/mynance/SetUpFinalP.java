    ...
    View.OnClickListener onClickfin1EnterButton = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            if(fin1DbMgr.getIncomes().size() == 0) {
                ...
                //fin1MoneyInA = fin1StartBal * fin1DbMgr.retrieveAPercentage();
                //fin1MoneyInB = fin1StartBal * fin1DbMgr.retrieveBPercentage();
                fin1MoneyInA = fin1StartBal * (fin1DbMgr.sumTotalAExpenses() / fin1DbMgr.sumTotalIncome());
                fin1MoneyInB = fin1StartBal - fin1MoneyInA;
            }

            fin1MoneyInDb = new MoneyInDb(
            ...
            fin1DbMgr.addMoneyIn(fin1MoneyInDb);

            fin1CurrDb = new CurrentDb(
                    fin1StartBal,
                    fin1MoneyInB,
                    fin1MoneyInA,
                    0.0,
            ...
            fin1DbMgr.addCurrent(fin1CurrDb);
