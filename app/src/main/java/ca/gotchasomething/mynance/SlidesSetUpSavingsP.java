...
public class SlidesSetUpSavingsP extends AppCompatActivity implements View.OnClickListener {
    ...
    private int[] slides = {
            R.layout.slides_set_up_savings_1,
            R.layout.slides_set_up_savings_2
    };
