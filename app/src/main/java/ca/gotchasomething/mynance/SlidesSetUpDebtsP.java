...
public class SlidesSetUpDebtsP extends AppCompatActivity implements View.OnClickListener {
    ...
    private int[] slides = {
            R.layout.slides_set_up_debts_1,
            R.layout.slides_set_up_debts_2,
            R.layout.slides_set_up_debts_3
    };
